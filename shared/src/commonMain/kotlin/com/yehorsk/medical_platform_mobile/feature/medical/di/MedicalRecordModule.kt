...
import com.yehorsk.medical_platform_mobile.feature.medical.data.service.MedicalRecordServiceImpl
...
val medicalRecordModule = module {
    ...
    singleOf(::MedicalRecordServiceImpl) bind MedicalRecordService::class
}